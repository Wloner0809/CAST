...
def predict(obs, info, model, softmax=False, rule=False, bart_model=None):
    ...
    if valid_acts[0].startswith('search['):
        if bart_model is None:
            ...
            query = query[0]  # Use the highest-ranked generated query deterministically.
...
if __name__ == "__main__":
    ...
    for i in range(500):
        ...
        # Convert the environment's 0-10 score to the paper's 0-100 scale.
        print(i, '|', score_softmax * 10, score_rule * 10)
