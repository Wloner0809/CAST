...
# Root dir for WebShop data files. Override via env var WEBSHOP_DATA_DIR.
WEBSHOP_DATA_DIR = os.environ.get("WEBSHOP_DATA_DIR", "./data/datasets/webshop/webshop_data")
...
FEAT_CONV = join(WEBSHOP_DATA_DIR, "feat_conv.pt")
FEAT_IDS = join(WEBSHOP_DATA_DIR, "feat_ids.pt")
