#!/usr/bin/env bash
#
# Launch the Sokoban trajectory visualizer.
#
...
#
# Usage:
#   ./sokoban.sh                         # list available experiments
#   ./sokoban.sh <experiment-name>       # a ckpt dir name under CKPT_ROOT
#   ./sokoban.sh /abs/path/chat_completions   # an explicit directory
#   ./sokoban.sh <name> --port 8800 --theme light
#   ./sokoban.sh --list                  # list available experiments
#
...
VISUALIZER="${VISUAL_DIR}/sokoban_visual.py"
...
list_experiments() {
  ...
  # 2 levels and report the path relative to CKPT_ROOT (which is what you pass
