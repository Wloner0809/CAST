...
=================================
A web-based viewer for Minesweeper RL rollout/validation trajectories stored
as torch ``.pt`` files.
...
Usage:
    python3 minesweeper_visual_pt.py --path <file.pt | dir_of_pt_files> [--port 8768]
"""
...
def main():
    parser = argparse.ArgumentParser(description='Minesweeper Trajectory Visualizer (.pt)')
    ...
    print("\U0001F4A3 Minesweeper Trajectory Visualizer (.pt)")
    print(f"{'-' * 44}")
