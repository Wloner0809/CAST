...
=============================
A web-based viewer for Sokoban RL rollout/validation trajectories
...
Usage:
    python3 sokoban_visual.py --path <chat_completions_dir> [--port 8765]

Example:
    python3 sokoban_visual.py --path .../chat_completions
"""
...
def main():
    parser = argparse.ArgumentParser(description='Sokoban Trajectory Visualizer')
    ...
    print("\U0001F4E6 Sokoban Trajectory Visualizer")
    print(f"{'-' * 44}")
