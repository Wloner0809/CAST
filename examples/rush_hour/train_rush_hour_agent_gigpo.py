"""Rush Hour training entrypoint using GiGPO advantage estimation.

This is the GiGPO variant of ``train_rush_hour_agent.py``.  The only
...
def _print_run_info(config, train_dataset, val_dataset):
    ...
    print(sep)
    print("  RUSH HOUR TRAINING RUN INFO (GiGPO)")
    print(sep)
    print(f"  mode       : gigpo")
