...
CKPT_DIR_BASENAME="${CKPT_DIR_BASENAME:-${MODEL_BASENAME}-minesweeper-agent-${DATASET_DIFFICULTY}}"
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-${MODEL_BASENAME}-minesweeper-agent-${DATASET_DIFFICULTY}}"
export MODEL_NAME="${MODEL_NAME:-${CKPT_DIR_BASENAME}_BS${TRAIN_BATCH_SIZE}_MPL${MAX_PROMPT_LENGTH}_MRL${MAX_RESPONSE_LENGTH}_MS${MAX_STEPS}}"
...
TRAINING_CMD=(
python3 -m examples.minesweeper.train_minesweeper_agent_gigpo
