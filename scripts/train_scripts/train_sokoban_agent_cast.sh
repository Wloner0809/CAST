...
# "cast" is the method reported in the paper; "off" falls back to plain GRPO.
ORACLE_ADV_MODE="${ORACLE_ADV_MODE:-cast}"
...
export WANDB_DIR="${WANDB_DIR:-${REPO_ROOT:-.}/outputs/sokoban-}"
